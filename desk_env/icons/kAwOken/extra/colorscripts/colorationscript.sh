...
WOKENCOL="kAwOken-$COL"
ICNST="kAwOken"
ICNSTP="kawoken"
ICNSTCNF=".kAwOkenrc"
ICNS="`kde4-config --localprefix`share/icons"
...
colorizeactions() {
  for k in *; do
    if [ -f $k ] && ! [ -L $k ] && [ ${k##*.} != "sh" ] && [ ${k##*.} != "svg" ] && [ ${k##*.} != "pdf" ] && [ ${k: -5} != "1.png" ] && [ ${k: -5} != "9.png" ] && [ $k != "address-book-new.png" ] && [ $k != "document-open-recent.png" ] && [ $k != "appointment-new.png" ] && [ $k != "bookmark_add.png" ] && [ $k != "bookmarks_list-add.png" ] && [ $k != "jockey-enabled.png" ] && [ $k != "jockey-free.png" ] && [ $k != "jockey-proprietary.png" ] && [ $k != "mail-send.png" ] && [ $k != "mail-message-new.png" ] && [ $k != "playlist-new.png" ] && [ $k != "playlist.png" ] && [ $k != "audio-cd-new.png" ] && [ $k != "contact-new.png" ] && [ $k != "gtk-spell-check.png" ] && [ $k != "internet-radio-new.png" ] && [ $k != "stock_new-tab.png" ] && [ $k != "window-new.png" ] && [ $k != "touchpad-enabled.png" ] && [ $k != "touchpad-disabled.png" ] && [ $k != "iso-image-burn.png" ] && [ $k != "iso-image-new.png" ] && [ $k != "media-optical-data-new.png" ] && [ $k != "media-optical-video.png" ] && [ $k != "continue-data-project.png" ] && [ $k != "tab-close.png" ] && [ $k != "tab-close-other.png" ] && [ $k != "list-remove-user.png" ] && [ $k != "media-clear-playlist-amarok.png" ] && [ $k != "media-track-add-amarok.png" ] && [ $k != "media-track-remove-amarok.png" ] && [ $k != "user-group-delete.png" ] && [ $k != "user-group-new.png" ] && [ $k != "media-optical-video-new.png" ] && [ $k != "mail-mark-important.png" ] && [ $k != "mail-mark-junk.png" ] && [ $k != "mail-mark-notjunk.png" ] && [ $k != "mail-mark-unread.png" ];then
      convert $k $command $k &
    fi
