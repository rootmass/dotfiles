...
if [ -x /usr/bin/zenity ]; then 
  ...
  echo "Due to the experimental nature of the script, I recommend you to check the README pdf file to fully understand what you have to know to use it. Do you want to read the PDF file? ([y]/n)"
  read RISP
  if [ "$RISP" != "n" ];then
    RISP="Yes"
  fi
