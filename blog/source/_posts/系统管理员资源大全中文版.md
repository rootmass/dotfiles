...
* Ctop 命令行的容器监视工具[官网](https://bcicen.github.com/ctop)
* Seagull 提供web管理和监控[官网](https://github.com/tobegit2hub/seagull)

### [原文链接](https://github.com/jobbole/awesome-sysadmin-cn)
